    ...
    return (
        <div className="space-y-8">
            <section className="ap-panel p-8">
                <p className="ap-eyebrow">Director</p>
                ...
                <p className="mt-4 max-w-3xl text-sm leading-7 text-[var(--color-text-soft)]">
                    Aquí ves los avisos internos del sistema. Un milagro mínimo de orden
                    dentro del caos administrativo.
                </p>
            </section>
