...
export default async function PsicologiaNotificationsPage() {
    const session = await requireRolePageAccess(ROLE.PSICOLOGIA, {
        loginPath: "/login?next=/psicologia/notifications",
        forbiddenPath: "/login?next=/psicologia/notifications",
    });
        ...
        <div className="space-y-8">
            <section className="ap-panel p-8">
                ...
                <p className="mt-4 max-w-3xl text-sm leading-7 text-[var(--color-text-soft)]">
                    Avisos internos relacionados con casos asignados a Psicología.
                </p>
            </section>
