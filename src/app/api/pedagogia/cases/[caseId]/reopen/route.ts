...
import { reopenReferralCaseSchema } from "@/shared/schemas/referrals/referral-workflow.schema";
import { reopenSupportAreaCase } from "@/server/domains/support/service";
...
export async function POST(request: NextRequest, context: RouteContext) {
    try {
        ...
        const input = reopenReferralCaseSchema.parse(rawBody);

        const detail = reopenSupportAreaCase(
            {
